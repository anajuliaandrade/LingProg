function cadastraFarmacias(vetor){ // cadastra as farmácias
    for(let i=0;i<5;i++){
        let objeto = {
...
//cadastrar os remedios
function remedios(vetor){
    for(let i=0;i<5;i++){
        let objeto = {
...
//efetuar venda
function realiza5VendasDeRemedio(vetor){
    for(let i=0;i<5;i++){
        let venda = {
...
function principal(){
    ...
    let remedio =[]
    remedios(remedio)
    realiza5VendasDeRemedio(remedio)
}